...
export const seoRouter = router({
  ...
  getAllPages: adminProcedure.query(async () => {
    ...
    if (!db)
      throw new TRPCError({
        ...
        message: "DB bağlantısı kurulamadı",
      });
  ...
  getPage: publicProcedure
    ...
    .query(async ({ input }) => {
      ...
      const [page] = await db
        .select()
        .from(seoSettings)
        .where(eq(seoSettings.pageSlug, input.pageSlug));
      return page || null;
    }),
  ...
  createPage: adminProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      if (existing) {
        throw new TRPCError({
          code: "CONFLICT",
          message: "Bu sayfa slug'ı zaten mevcut",
        });
      }
  ...
  updateGlobalConfig: adminProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      if (existing) {
        await db
          .update(globalSeoConfig)
          .set(input)
          .where(eq(globalSeoConfig.id, existing.id));
      } else {
  ...
  initializeDefaultPages: adminProcedure.mutation(async () => {
    ...
    const defaultPages = [
      {
        pageSlug: "home",
        pageName: "Ana Sayfa",
        metaTitle: "NanoInf - AI Görsel ve Video Oluşturucu",
        metaDescription:
          "Profesyonel AI görseller, videolar ve karakterler oluşturun. Saniyeler içinde.",
      },
      {
        pageSlug: "generate",
        pageName: "Görsel Oluştur",
        metaTitle: "AI Görsel Oluştur | NanoInf",
        metaDescription:
          "Yapay zeka ile profesyonel görseller oluşturun. Nano Banana Pro, Qwen ve SeeDream modelleri.",
      },
      {
        pageSlug: "video",
        pageName: "Video Oluştur",
        metaTitle: "AI Video Oluştur | NanoInf",
        metaDescription:
          "Veo 3.1, Sora 2, Kling ile AI video oluşturun. Text-to-video ve image-to-video.",
      },
      {
        pageSlug: "gallery",
        pageName: "Galeri",
        metaTitle: "AI Galeri | NanoInf",
        metaDescription: "Oluşturduğunuz AI görseller ve videolar.",
      },
      {
        pageSlug: "ai-influencer",
        pageName: "AI Influencer",
        metaTitle: "AI Influencer Oluştur | NanoInf",
        metaDescription: "Kendi AI karakterinizi oluşturun ve yönetin.",
      },
      {
        pageSlug: "upscale",
        pageName: "Görsel Upscale",
        metaTitle: "Görsel Upscale | NanoInf",
        metaDescription: "Düşük çözünürlüklü görselleri 8K'ya yükseltin.",
      },
      {
        pageSlug: "packages",
        pageName: "Paketler",
        metaTitle: "Kredi Paketleri | NanoInf",
        metaDescription: "NanoInf kredi paketleri ve fiyatları.",
      },
      {
        pageSlug: "blog",
        pageName: "Blog",
        metaTitle: "Blog | NanoInf",
        metaDescription:
          "AI ve görsel oluşturma hakkında en son haberler ve ipuçları.",
      },
      {
        pageSlug: "profile",
        pageName: "Profil",
        metaTitle: "Profilim | NanoInf",
        metaDescription: "Hesap ayarları ve kredi bilgileri.",
      },
      {
        pageSlug: "multi-angle",
        pageName: "Çoklu Açı",
        metaTitle: "Çoklu Açı Fotoğraf | NanoInf",
        metaDescription: "Tek fotoğraftan 4-8 farklı açı oluşturun.",
      },
      {
        pageSlug: "product-promo",
        pageName: "Ürün Tanıtım",
        metaTitle: "Ürün Tanıtım Videosu | NanoInf",
        metaDescription: "E-ticaret için profesyonel ürün tanıtım videoları.",
      },
      {
        pageSlug: "skin-enhancement",
        pageName: "Cilt İyileştirme",
        metaTitle: "AI Cilt İyileştirme | NanoInf",
        metaDescription: "Doğal ve profesyonel cilt iyileştirme.",
      },
    ];
    ...
    for (const page of defaultPages) {
      const [existing] = await db
        .select()
        .from(seoSettings)
        .where(eq(seoSettings.pageSlug, page.pageSlug));
      if (!existing) {
  ...
  getStats: adminProcedure.query(async () => {
    ...
    const stats = {
      ...
      pagesWithTwitter: pages.filter(p => p.twitterTitle && p.twitterImage)
        .length,
