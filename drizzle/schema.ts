...
export const activityLogs = mysqlTable(
  ...
  table => [primaryKey({ columns: [table.id], name: "activityLogs_id" })]
);
...
export const adminUsersExtended = mysqlTable(
  "adminUsersExtended",
  {
    id: int().autoincrement().notNull(),
    userId: int()
...
export const aiCharacterImages = mysqlTable(
  "aiCharacterImages",
  {
    id: int().autoincrement().notNull(),
    characterId: int()
  ...
  table => [
    ...
    index("ai_char_images_user_created_idx").on(table.userId, table.createdAt),
    index("ai_char_images_char_created_idx").on(
      table.characterId,
      table.createdAt
    ),
    index("ai_char_images_task_idx").on(table.taskId),
  ]
);

export const aiCharacters = mysqlTable(
  "aiCharacters",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [
    ...
    index("ai_characters_user_created_idx").on(table.userId, table.createdAt),
    index("ai_characters_public_usage_idx").on(
      table.isPublic,
      table.usageCount
    ),
  ]
...
export const announcements = mysqlTable(
  "announcements",
  {
    ...
    targetAudience: mysqlEnum(["all", "logged_in", "logged_out", "new_users"])
      .default("all")
      .notNull(),
...
export const apiUsageStats = mysqlTable(
  "apiUsageStats",
  {
    id: int().autoincrement().notNull(),
  ...
  table => [primaryKey({ columns: [table.id], name: "apiUsageStats_id" })]
);

export const bannedEmails = mysqlTable(
  "bannedEmails",
  {
    id: int().autoincrement().notNull(),
...
export const bannedIps = mysqlTable(
  "bannedIps",
  {
    id: int().autoincrement().notNull(),
...
export const creditPackages = mysqlTable(
  ...
  table => [primaryKey({ columns: [table.id], name: "creditPackages_id" })]
);
...
export const creditTransactions = mysqlTable(
  ...
  table => [primaryKey({ columns: [table.id], name: "creditTransactions_id" })]
);

export const discountCodeUsage = mysqlTable(
  "discountCodeUsage",
  {
    id: int().autoincrement().notNull(),
    discountCodeId: int()
  ...
  table => [primaryKey({ columns: [table.id], name: "discountCodeUsage_id" })]
);
...
export const errorLogs = mysqlTable(
  ...
  table => [primaryKey({ columns: [table.id], name: "errorLogs_id" })]
);
...
export const faqs = mysqlTable(
  ...
  table => [primaryKey({ columns: [table.id], name: "faqs_id" })]
);
...
export const favorites = mysqlTable(
  ...
  table => [
    ...
    unique("favorites_user_image_unique").on(table.userId, table.imageId),
    index("favorites_user_created_idx").on(table.userId, table.createdAt),
  ]
);

export const featurePricing = mysqlTable(
  "featurePricing",
  {
    id: int().autoincrement().notNull(),
    ...
    description: text(),
    isActive: tinyint().default(1).notNull(),
    kieModelDescription: varchar({ length: 300 }),
    kieInterfaceType: varchar({ length: 50 }),
    kieProvider: varchar({ length: 100 }),
    kieCreditPrice: varchar({ length: 50 }),
    kieCreditUnit: varchar({ length: 100 }),
    kieUsdPrice: varchar({ length: 50 }),
...
export const feedbacks = mysqlTable(
  "feedbacks",
  {
    ...
    description: text().notNull(),
    screenshotUrl: text(),
    status: mysqlEnum(["new", "in_progress", "resolved", "closed"])
      .default("new")
      .notNull(),
    adminNotes: text(),
    userAgent: text(),
  ...
  table => [primaryKey({ columns: [table.id], name: "feedbacks_id" })]
);

export const flaggedPrompts = mysqlTable(
  "flaggedPrompts",
  {
    id: int().autoincrement().notNull(),
    userId: int()
    ...
    status: mysqlEnum(["pending", "approved", "rejected", "banned"])
      .default("pending")
      .notNull(),
  ...
  table => [primaryKey({ columns: [table.id], name: "flaggedPrompts_id" })]
);
...
export const generatedImages = mysqlTable(
  ...
  table => [
    ...
    index("gen_images_user_created_idx").on(table.userId, table.createdAt),
    index("gen_images_user_status_created_idx").on(
      table.userId,
      table.status,
      table.createdAt
    ),
    index("gen_images_task_idx").on(table.taskId),
    index("gen_images_status_created_idx").on(table.status, table.createdAt),
  ]
);

export const globalSeoConfig = mysqlTable(
  "globalSeoConfig",
  {
    id: int().autoincrement().notNull(),
  ...
  table => [primaryKey({ columns: [table.id], name: "globalSeoConfig_id" })]
);
...
export const ipLoginHistory = mysqlTable(
  "ipLoginHistory",
  {
    id: int().autoincrement().notNull(),
    userId: int()
    ...
    deviceType: mysqlEnum(["desktop", "mobile", "tablet", "unknown"]).default(
      "unknown"
    ),
    browser: varchar({ length: 100 }),
    os: varchar({ length: 100 }),
    loginType: mysqlEnum(["login", "register", "api_access"])
      .default("login")
      .notNull(),
  ...
  table => [primaryKey({ columns: [table.id], name: "ipLoginHistory_id" })]
);
...
export const jobQueue = mysqlTable(
  ...
  table => [primaryKey({ columns: [table.id], name: "jobQueue_id" })]
);

export const modalCards = mysqlTable(
  "modalCards",
  {
    id: int().autoincrement().notNull(),
...
export const multiAngleImages = mysqlTable(
  "multiAngleImages",
  {
    id: int().autoincrement().notNull(),
    jobId: int()
      .notNull()
      .references(() => multiAngleJobs.id, { onDelete: "cascade" }),
    angleIndex: int().notNull(),
    angleName: varchar({ length: 100 }).notNull(),
    prompt: text().notNull(),
    generatedImageUrl: text(),
    taskId: varchar({ length: 255 }),
    status: mysqlEnum(["pending", "processing", "completed", "failed"])
      .default("pending")
      .notNull(),
    errorMessage: text(),
    createdAt: timestamp({ mode: "string" }).defaultNow().notNull(),
  ...
  table => [
    ...
    index("multi_angle_images_job_idx").on(table.jobId, table.angleIndex),
    index("multi_angle_images_job_status_idx").on(table.jobId, table.status),
    index("multi_angle_images_task_idx").on(table.taskId),
  ]
);

export const multiAngleJobs = mysqlTable(
  "multiAngleJobs",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [
    ...
    index("multi_angle_jobs_user_created_idx").on(
      table.userId,
      table.createdAt
    ),
    index("multi_angle_jobs_status_created_idx").on(
      table.status,
      table.createdAt
    ),
  ]
...
export const paymentRecords = mysqlTable(
  ...
  table => [
    ...
    index("payment_records_user_created_idx").on(table.userId, table.createdAt),
    index("payment_records_status_created_idx").on(
      table.status,
      table.createdAt
    ),
    index("payment_records_external_txn_idx").on(table.externalTransactionId),
  ]
);

export const productPromoVideos = mysqlTable(
  "productPromoVideos",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [primaryKey({ columns: [table.id], name: "productPromoVideos_id" })]
);

export const promptBlacklist = mysqlTable(
  "promptBlacklist",
  {
    id: int().autoincrement().notNull(),
    pattern: varchar({ length: 500 }).notNull(),
    patternType: mysqlEnum([
      "exact",
      "contains",
      "regex",
      "starts_with",
    ...
    severity: mysqlEnum(["low", "medium", "high", "critical"])
      .default("medium")
      .notNull(),
    actionType: mysqlEnum(["block", "warn", "flag_for_review", "auto_ban"])
      .default("block")
      .notNull(),
    warningMessage: text(),
    isActive: tinyint().default(1).notNull(),
  ...
  table => [primaryKey({ columns: [table.id], name: "promptBlacklist_id" })]
);

export const promptHistory = mysqlTable(
  "promptHistory",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [
    ...
    index("prompt_history_user_last_used_idx").on(
      table.userId,
      table.lastUsedAt
    ),
    index("prompt_history_user_res_aspect_idx").on(
      table.userId,
      table.resolution,
      table.aspectRatio
    ),
...
export const referrals = mysqlTable(
  ...
  table => [primaryKey({ columns: [table.id], name: "referrals_id" })]
);
...
export const seoSettings = mysqlTable(
  "seoSettings",
  {
    ...
    ogImage: text(),
    ogType: mysqlEnum(["website", "article", "product", "profile"]).default(
      "website"
    ),
    ogLocale: varchar({ length: 10 }).default("tr_TR"),
    twitterCard: mysqlEnum([
      "summary",
      "summary_large_image",
      "app",
      "player",
...
export const shopierOrders = mysqlTable(
  "shopierOrders",
  {
    id: int().autoincrement().notNull(),
    userId: int()
...
export const skinEnhancementJobs = mysqlTable(
  "skinEnhancementJobs",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [primaryKey({ columns: [table.id], name: "skinEnhancementJobs_id" })]
);

export const stripeOrders = mysqlTable(
  "stripeOrders",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [
    ...
    index("stripe_orders_user_created_idx").on(table.userId, table.createdAt),
    index("stripe_orders_status_created_idx").on(table.status, table.createdAt),
    index("stripe_orders_payment_intent_idx").on(table.stripePaymentIntentId),
  ]
);

export const systemRateLimits = mysqlTable(
  "systemRateLimits",
  {
    id: int().autoincrement().notNull(),
...
export const ugcAdVideos = mysqlTable(
  "ugcAdVideos",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [primaryKey({ columns: [table.id], name: "ugcAdVideos_id" })]
);

export const upscaleHistory = mysqlTable(
  "upscaleHistory",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [
    ...
    index("upscale_history_user_created_idx").on(table.userId, table.createdAt),
    index("upscale_history_user_task_idx").on(table.userId, table.taskId),
  ]
);

export const userPromptTemplates = mysqlTable(
  "userPromptTemplates",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [primaryKey({ columns: [table.id], name: "userPromptTemplates_id" })]
);
...
export const userWarnings = mysqlTable(
  "userWarnings",
  {
    ...
    severity: mysqlEnum(["notice", "warning", "final_warning"])
      .default("warning")
      .notNull(),
    reason: text().notNull(),
  ...
  table => [primaryKey({ columns: [table.id], name: "userWarnings_id" })]
);
...
export const users = mysqlTable(
  ...
  table => [
    ...
    index("users_email_verification_clerk_idx").on(
      table.emailVerificationClerkId
    ),
    index("users_email_verification_code_idx").on(table.emailVerificationCode),
...
export const videoFavorites = mysqlTable(
  "videoFavorites",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [
    ...
    unique("video_favorites_user_video_unique").on(table.userId, table.videoId),
    index("video_favorites_user_created_idx").on(table.userId, table.createdAt),
  ]
);

export const videoGenerations = mysqlTable(
  "videoGenerations",
  {
    id: int().autoincrement().notNull(),
    userId: int()
  ...
  table => [
    ...
    index("video_generations_user_created_idx").on(
      table.userId,
      table.createdAt
    ),
    index("video_generations_task_idx").on(table.taskId),
    index("video_generations_status_created_idx").on(
      table.status,
      table.createdAt
    ),
    index("video_generations_user_status_created_idx").on(
      table.userId,
      table.status,
      table.createdAt
    ),
...
export const viralAppsConfig = mysqlTable(
  "viralAppsConfig",
  {
    id: int().autoincrement().notNull(),
