...
import { users, activityLogs, adminRoles, adminUsersExtended, aiCharacters, aiCharacterImages, bannedEmails, bannedIps, creditTransactions, discountCodes, discountCodeUsage, errorLogs, generatedImages, favorites, feedbacks, flaggedPrompts, promptBlacklist, videoGenerations, ipLoginHistory, jobQueue, multiAngleJobs, multiAngleImages, notifications, paymentRecords, creditPackages, productPromoVideos, promptHistory, referrals, shopierOrders, skinEnhancementJobs, stripeOrders, ugcAdVideos, upscaleHistory, userPromptTemplates, userSessions, userWarnings, videoFavorites } from "./schema";
...
export const adminUsersExtendedRelations = relations(adminUsersExtended, ({one}) => ({
...
export const aiCharacterImagesRelations = relations(aiCharacterImages, ({one}) => ({
...
export const aiCharactersRelations = relations(aiCharacters, ({one, many}) => ({
	aiCharacterImages: many(aiCharacterImages),
	user: one(users, {
...
export const flaggedPromptsRelations = relations(flaggedPrompts, ({one, many}) => ({
	generatedImage: one(generatedImages, {
...
export const promptBlacklistRelations = relations(promptBlacklist, ({one, many}) => ({
	flaggedPrompts: many(flaggedPrompts),
	user: one(users, {
...
export const videoGenerationsRelations = relations(videoGenerations, ({one, many}) => ({
	flaggedPrompts: many(flaggedPrompts),
	videoFavorites: many(videoFavorites),
	user: one(users, {
...
export const multiAngleImagesRelations = relations(multiAngleImages, ({one}) => ({
...
export const multiAngleJobsRelations = relations(multiAngleJobs, ({one, many}) => ({
...
export const productPromoVideosRelations = relations(productPromoVideos, ({one}) => ({
	user: one(users, {
...
export const skinEnhancementJobsRelations = relations(skinEnhancementJobs, ({one}) => ({
	user: one(users, {
...
export const userPromptTemplatesRelations = relations(userPromptTemplates, ({one}) => ({
	user: one(users, {
