# Higgsfield.ai Mobil Tasarım Analizi
...
- 2 sütunlu grid: Create Image, Create Video kartları
  - Her kartta görsel, başlık, açıklama, ok ikonu
- "Explore all tools" butonu (yeşil/lime, tam genişlik)
- "TOP CHOICE" bölümü - horizontal scroll kartlar
  - UNLIMITED, PRO badge'leri
...
- 2 sütunlu grid araç kartları
  - CORE, NEW, UNLIMITED badge'leri
