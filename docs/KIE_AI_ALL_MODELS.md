# Kie.ai Tüm Modeller Listesi

Bu liste, Kie.ai entegrasyonu için desteklenen tüm video ve resim modellerini içerir. Admin panelinden bu modelleri veritabanına ekleyebilirsiniz.
...
- **Tip:** Video
- **Maliyet:** 55
- **Açıklama:** ByteDance'ın (TikTok) en gelişmiş video modeli.
...
- **Tip:** Image
- **Maliyet:** 10
- **Açıklama:** Dengeli ve çok yönlü resim modeli.

## ⚙️ Nasıl Eklenir?

`/admin/models` sayfasına gidin ve "Model Ekle" butonu ile yukarıdaki bilgileri girin.
`Provider` olarak mutlaka `kie_ai` seçilmelidir.
Model Key alanları API entegrasyonu için **birebir aynı** olmalıdır.
