...
> = {
  ...
  "nano-banana-pro": {
    ...
    description:
      "Nano Banana'nın en güçlü görüntü modeli. Işık hızında üretim ve ultra gerçekçi detaylar.",
  },
  ...
  "flux-2-pro": {
    ...
    description:
      "Black Forest Labs'in amiral gemisi. Olağanüstü kompozisyon ve sanatsal derinlik.",
  },
  ...
  "flux-kontext-pro": {
    ...
    description:
      "Bağlamı anlayan akıllı model. Karmaşık sahnelerde üstün tutarlılık sağlar.",
  },
  ...
  "google-imagen4": {
    ...
    description:
      "Google'ın en gelişmiş görüntü modeli. Fotogerçekçilikte yeni bir standart.",
  },
  ...
  "4o-image": {
    ...
    description:
      "GPT-4o Vision tabanlı görüntü üretimi. Doğal dil anlayışı ile hassas sonuçlar.",
  },
  ...
  "ideogram-v3": {
    ...
    description:
      "Metin ve tipografide lider. Posterler, logolar ve sanatsal tasarımlar için ideal.",
  },
  ...
  "ideogram-character": {
    ...
    description:
      "Karakter tasarımında uzmanlaşmış Ideogram modeli. Tutarlı ve detaylı portreler.",
  },
  ...
  seedream: {
    ...
    description:
      "Rüya gibi sahneler ve hayal gücünün sınırlarını zorlayan kompozisyonlar.",
  },
  ...
  "seedream-edit": {
    ...
    description:
      "Mevcut görselleri düzenleyin, dönüştürün ve yeniden hayal edin.",
  },
  ...
  "grok-imagine": {
    ...
    description:
      "xAI tarafından geliştirilen cesur ve minimalist görüntü modeli.",
  },
  ...
  qwen: {
    ...
    description:
      "Alibaba Cloud'un güçlü Qwen modeli. Çok dilli ve yüksek performanslı üretim.",
  },
  ...
  "qwen-image": {
    ...
    mobile: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb",
    description:
      "Qwen vizyon yetenekleriyle görseller üzerinde hassas düzenlemeler yapın.",
  },
  ...
  "z-image": {
    ...
    description:
      "Hızlı, verimli ve keskin görüntü üretimi için optimize edilmiş Z serisi.",
  },
  ...
  "gpt-image-1.5": {
    ...
    mobile: "https://images.unsplash.com/photo-1677442136019-21780ecad995",
    description:
      "Gelişmiş GPT mimarisi ile 1.5 sürüm görüntü oluşturma yetenekleri.",
  },
  ...
  veo3: {
    ...
    description:
      "Google Veo 3.1. Sinematik kalitede, yüksek çözünürlüklü video üretimi.",
  },
  ...
  sora2: {
    ...
    description:
      "OpenAI Sora 2. Gerçek dünyayı simüle eden, fizik kurallarına sadık videolar.",
  },
  ...
  "sora2-pro": {
    ...
    description:
      "Sora 2 Pro. Profesyonel projeleriniz için uzun süreli ve yüksek detaylı videolar.",
  },
  ...
  "kling-25": {
    ...
    description:
      "Kling 2.5: Geliştirilmiş hareket algoritmaları ve görsel kalite.",
  },
  ...
  hailuo: {
    ...
    description:
      "Hailuo 2.3. Hızlı, verimli ve yaratıcı video sahneleri oluşturur.",
  },
