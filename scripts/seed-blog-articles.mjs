...
const articles = JSON.parse(
  readFileSync(join(__dirname, "..", "blog-articles.json"), "utf-8")
);

// Cover image mapping
const coverImages = {
  "ai-gorsel-olusturma-rehberi-2024": "/blog-covers/yapay-zeka-fotograf.jpg",
  "e-ticarette-urun-fotografciligi-ai-cozumleri":
    "/blog-covers/e-ticaret-urun-fotografi.jpg",
  "sosyal-medya-icerik-stratejisi-ai-araclari":
    "/blog-covers/sosyal-medya-icerik.jpg",
  "ai-influencer-nedir-sanal-influencer":
    "/blog-covers/ai-influencer-nedir.jpg",
  "gorsel-kalite-artirma-upscale-teknolojisi":
    "/blog-covers/gorsel-optimizasyon.jpg",
  "ai-video-icerik-uretimi-sora-veo-kling":
    "/blog-covers/gelecek-trendleri.jpg",
...
async function seedBlogArticles() {
  ...
  for (const article of articles) {
    try {
      ...
      const coverImage =
        coverImages[article.slug] || "/blog-covers/ai-influencer-nedir.jpg";
